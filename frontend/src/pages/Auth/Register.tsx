  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-72 h-72 bg-gradient-to-br from-purple-400/20 to-pink-400/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 left-1/4 w-72 h-72 bg-gradient-to-br from-blue-400/20 to-purple-400/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
        ...
        <div className="relative backdrop-blur-xl bg-white/80 shadow-2xl rounded-2xl border border-white/20 overflow-hidden">
          ...
          <div className="relative p-8 space-y-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-2">Start sharing your stories today</p>
            </div>
